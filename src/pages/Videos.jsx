...
const Videos = () => {
 ...
 return (
  <div className="container-fluid videos-page">
    <div className="row flex-nowrap">
      ...
      {/* Main Content */}
      <main className="col px-3 px-md-4 videos-content">

        {/* Header */}
        <div className="videos-header d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
          ...
          <div>
            <h1 className="videos-title">
              {activeCategory === "all"
                ? "All Videos"
                : activeCategory.startsWith("channel_")
                ? getChannelTitle(activeCategory)
          ...
          <div className="d-flex flex-wrap gap-2 w-100 w-md-auto">
            ...
            <button
              className="btn btn-danger d-flex align-items-center gap-2 w-100 w-md-auto"
            ...
            <button
              className="btn btn-outline-danger d-flex align-items-center gap-2 w-100 w-md-auto"
        ...
        <div className="row g-4">
          {filteredVideos.map((video) => {
            const finalVideoUrl =
              video.category === "Live"
                ? `https://livepeercdn.studio/hls/${video.video_url}/index.m3u8`
                : supabase.storage
                    .from("video")
            ...
            return (
              <div key={video.id} className="col-12 col-sm-6 col-md-4 col-xl-3">
                <VideoCard
                  video={{
                    ...video,
