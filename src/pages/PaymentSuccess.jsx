      ...
      <div style={styles.card}>
        ...
        {status === 'success' && (
          <>
            ...
            <p style={styles.text}>{message}</p>
            <button onClick={() => navigate('/music')} style={styles.button}>
              Go to Library
            </button>
          </>
        )}
        ...
        {status === 'error' && (
          <>
            ...
            <p style={styles.subtext}>If money was deducted, contact support.</p>
            <button onClick={() => navigate('/music')} style={{...styles.button, background: '#333'}}>
              Go Back
            </button>
          </>
        )}
